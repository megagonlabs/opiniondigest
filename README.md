...
- `yelp.jsonl`: This file contains opinion extractions for 1.038M reviews from the Yelp dataset (extracted by [Snippext](https://github.com/rit-git/Snippext_public))
